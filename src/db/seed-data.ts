export const seedContentBlocks = [
  ...
  {
    key: "year-on-duty",
    title: "2026 Year on Duty",
    subtitle: "Called to faithful service",
    body: "A focused season for worship, witness, and student leadership as we serve Christ together on campus.",
    ctaLabel: "Download Weekly Guide",
    ctaHref: "/uploads/resources/student-bible-study-guide.pdf",
    metadata: JSON.stringify({
      currentYear: "2026 Academic Year",
      theme: "Rooted in Christ, Ready for Mission",
      keyText: "Colossians 2:7 - Rooted and built up in Him, strengthened in the faith as you were taught.",
      sopBook: "The Desire of Ages",
      guideTitle: "This Week's Sabbath School Guide",
      guideUrl: "/uploads/resources/student-bible-study-guide.pdf",
    }),
  },
  {
    key: "live-stream",
    title: "Divine Service - Sabbath",
    subtitle: "Watch Live",
    body: "Join the JOOUSDA church family online for worship, prayer, praise, and the preaching of God's Word.",
    ctaLabel: "Watch Live Now",
    ctaHref: "https://www.youtube.com/watch?v=4O7GQ7K2C9M",
    metadata: JSON.stringify({
      eventDate: "2026-05-09 10:50 AM EAT",
      status: "Upcoming",
      youtubeUrl: "https://www.youtube.com/watch?v=4O7GQ7K2C9M",
      embedCode: "https://www.youtube.com/embed/4O7GQ7K2C9M",
    }),
  },
];
...
export const seedHomepageSections = [
  ...
  { key: "live-stream", displayOrder: 4, enabled: true, isCustom: false },
  { key: "mission", displayOrder: 5, enabled: true, isCustom: false },
  {
    key: "history",
    title: "Our History",
  ...
  { key: "year-on-duty", displayOrder: 9, enabled: true, isCustom: false },
  { key: "departments", displayOrder: 10, enabled: true, isCustom: false },
  { key: "music-choirs", displayOrder: 11, enabled: true, isCustom: false },
  { key: "chaplain-message", displayOrder: 12, enabled: true, isCustom: false },
  { key: "next-steps", displayOrder: 13, enabled: true, isCustom: false },
  {
    key: "resources",
  ...
  { key: "sermons", displayOrder: 15, enabled: true, isCustom: false },
];
